...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ed07e83ddca7ab2, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ed07e83ddca7ab2, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "voidchain.voidchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "voidchain.voidchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("voidchain/voidchain/tx.proto", fileDescriptor_0ed07e83ddca7ab2) }

var fileDescriptor_0ed07e83ddca7ab2 = []byte{
	// 335 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x29, 0xcb, 0xcf, 0x4c,
	...
	0xab, 0xa4, 0x58, 0x1b, 0x40, 0xde, 0x71, 0x72, 0x3b, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0x9d, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0xfd, 0xa4,
	0x8a, 0x9c, 0xec, 0x5c, 0x7d, 0xec, 0xde, 0x2b, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xc7,
	0x90, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xc7, 0x72, 0xc6, 0x3d, 0x55, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/voidchain.voidchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/voidchain.voidchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "voidchain.voidchain.Msg",
	...
	Metadata: "voidchain/voidchain/tx.proto",
}
